package com.shindejayesharun.saveotask.util
...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.primary_color) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.colorAccent) }
